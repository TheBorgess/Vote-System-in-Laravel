         ...
         <div class="row" align="left">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="title" value="{{ $enquete->title }}" class="form-control" placeholder="Título">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
               <div class="form-group">
                  <label for="name"><strong>Início:</strong></label>
                  <input id="datepicker" name="start" width="250" value="{{ $enquete->start }}" required />
                  <script>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
               <div class="form-group">
                  ...
                  <input id="datepicker2" name="end" width="250" value="{{ $enquete->end }}" required />
                  <script>
